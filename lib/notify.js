...
//
// Sends as kontakt@marcoarpa.com over the domain verified in Resend.
// The sender must live on that domain - the Resend test sender only
// delivers to the account owner's own address. SPF and return-path sit
// on the send.marcoarpa.com subdomain, so they do not collide with the
// IONOS mail records on the apex.
...
const FROM = 'Marco Arpa Website <kontakt@marcoarpa.com>';
