...
const NOTIFICATION_EMAIL = process.env.NOTIFICATION_EMAIL || 'marco.arpa@outlook.de';
  ...
  <div style="max-width:640px;margin:0 auto;padding:32px 16px;">
    <div style="background:#fff;border:1px solid #e5e5e0;border-radius:12px;overflow:hidden;">
      <div style="padding:24px 24px 16px;border-bottom:1px solid #eee;">
        ...
        <div style="color:#666;font-size:13px;margin-top:6px;">via marco-arpa.vercel.app</div>
      </div>
